...
export default function WhyChooseUs() {
	return (
		<Wrapper className="py-16 px-20 bg-custom-103 flex justify-center rounded-tr-6xl">
			...
			<div className="w-1/2 flex flex-col">
				<div className="flex items-center">
					<span className="h-0.5 w-12 bg-custom-109 rounded-10xl"></span>
					<span className="text-sm italic text-custom-109 font-bold">Why Choose Us</span>
				</div>
				<span>
