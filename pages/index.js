...
export default function Home() {
	...
	const handleFetchGyms = async () => {
		...
		let res = await fetch(`${API_URL}/gyms?page_number=${page_number}&limit=${limit}`);
				...
				<div className="home-wrapper flex flex-col">
					...
					<section className="px-64 py-10 flex flex-col items-center sm:px-0">
						...
						<div className="flex flex-wrap justify-between">
							<div className="flex flex-col w-2/5 sm:w-full sm:px-16 sm:mb-20">
								<span className="text-custom-104 w-3/4 font-medium text-lg leading-7 mb-4">
									Finding creative digital agency company is not easy these days.
								</span>
							...
							<div className="w-2.5/5 h-56 sm:w-full">
								<img className="flex object-contain h-full w-full" src="/assets/homepage/workout.svg" />
							</div>
						</div>
					</section>
					{/* <div
					...
					<section className="bg-custom-103 py-16">
						<div className="w-1/2 pl-8">
							...
							<span className="block text-sm  mb-8">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
								incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
							</span>
							<div className="h-10">
								<input
									className="w-3/5 border-1 border-r-0 border-gray-300 rounded h-10"
									type="text"
